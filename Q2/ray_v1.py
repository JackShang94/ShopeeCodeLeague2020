...
Original file is located at
    https://colab.research.google.com/drive/12ikIYO-ZAwAoITJRKaWLWOZ4IVvOna2R
"""
...
print(curPath)
data_path = curPath + '\\Q2\\dataset\\shopee-product-detection-dataset\\'

# data_path = '/content/drive/My Drive/product_detection/'
im_size = 255
batch_size = 32
im_size = 150
...
train_transforms = transforms.Compose([
                                        ...
                                        transforms.ToTensor()])
train_data = torchvision.datasets.ImageFolder(root = data_path + 'train/train', transform = train_transforms)
train_loader = DataLoader(train_data, batch_size=batch_size, shuffle=True)

#image transformations for train and test data


def normalization_parameter(dataloader, nb_samples=5):
    mean = 0.
    std = 0.
    i = 0
...
1. train: train model to learn model weights
2. test: help to choose hyperparameters
"""

def data_loader(train_data, test_size = 0.2, batch_size = 32):
    
    data_len = len(train_data)
    test_size = int(test_size*data_len)
    ...
    for epoch in range(num_epochs):
        ...
        for phase in phase1:
            ...
            for  batch_idx, (data, target) in enumerate(dataloaders[phase]):
                ...
                # print('length of current batch', len(data), len(target))
                # print(target)
...
def train_model(model,dataloaders,criterion,num_epochs=1,lr=0.0001,batch_size=8,patience = None,classes = None):
    dataloader_train = {}
    losses = list()
    accuracy = list()
    ...
    torch.save(model, 'D:/PythonProjects/Model/model.pt')
    error_plot(losses)
    acc_plot(accuracy)
...
train_model(classifier,dataloaders,criterion,1, batch_size = batch_size , classes = classes)
